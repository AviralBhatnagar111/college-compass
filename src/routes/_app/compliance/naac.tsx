  ...
  return (
    <div>
      <PageHeader title="NAAC Cockpit" subtitle="7-criterion readiness with live evidence wiring"
        action={<div className="flex gap-2"><Button variant="outline"><Download className="h-4 w-4 mr-2" />SSR Draft</Button><Button>Run Self-Assessment</Button></div>} />
            ...
            {openId === c.id && (
              <div className="border-t px-5 py-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Button variant="outline" size="sm" className="mt-4"><FileText className="h-3 w-3 mr-1" />Generate Criterion Report</Button>
                </div>
              </div>
            )}
          </Card>
